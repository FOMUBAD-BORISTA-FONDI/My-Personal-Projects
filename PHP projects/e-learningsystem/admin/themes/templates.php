...
<head>
    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.html">Krypto-Learning System </a>
        ...
        <div class="wrapper">
                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <ul class="widget widget-menu unstyled">
                                <li><a href="<?php echo web_root; ?>admin/modules/galery/index.php"><i class="menu-icon icon-pencil"></i> Galery </a></li>
                                <li><a href="<?php echo web_root; ?>admin/modules/modstudent/index.php"><i class="menu-icon icon-user"></i> Manage Students </a></li>
         ...
         <div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2023 Krypto Buja </b>All rights reserved.
            </div>
        </div>

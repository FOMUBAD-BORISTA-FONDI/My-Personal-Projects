...
class PaymentController extends Controller
{
    ...
    public function depositConfirm(Request $request)
    {
        ...
        // Use the static price instead of querying the API
        $btcrate = 50000; // Replace with the static BTC price you want to use
        ...
        return view('user.payment.popup', compact('data','gnl', 'track', 'btcrate', 'all'));
    }
    // public function depositConfirm(Request $request)
    // {
    //     $user=User::find(Auth::user()->id);

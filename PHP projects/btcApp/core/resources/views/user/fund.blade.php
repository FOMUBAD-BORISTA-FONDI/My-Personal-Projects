...
<div class="container-fluid mt--6">
  <div class="content-wrapper">
        ...
        <div class="card bg-dark">
          ...
          <div class="card-body">
              <div class="row align-items-center">
                  <div class="col">
                      <h4 class="mb-0 text-yellow">
                          <p href="#">Payment Wallet</p>
                      </h4>
                      <p class="text-sm text-white mb-0">Wallet Address:</p>
                      <p class="text-sm text-gray mb-0">
                          <span id="walletAddressText">trdfsyekkdkdlTdl1kkddsfrtthjdsdfh</span>
                      </p>
                      <p class="text-sm text-white mb-0">Type: TRC20</p>
                  </div>
                  <button class="btn btn-primary btn-sm ml-3" id="copyWalletAddress">Copy Address</button>
              </div>
          </div>
      </div>
    ...
    <script>
      const copyButton = document.getElementById('copyWalletAddress');
      copyButton.addEventListener('click', () => {
          const walletAddressText = document.getElementById('walletAddressText');
          const tempInput = document.createElement('input');
          tempInput.value = walletAddressText.textContent;
          document.body.appendChild(tempInput);
          tempInput.select();
          document.execCommand('copy');
          document.body.removeChild(tempInput);
          alert('Wallet address copied: ' + walletAddressText.textContent);
      });
  </script>
@stop